...
public class MessageListViewHolder extends ClickyViewHolder<JoinedMessageItem> implements SlideViewInterface {
    private final String TAG = "MessageListViewHolder";

    // Views
    protected View mRoot;
    protected QKTextView mBodyTextView;
    protected TextView mTolchTextView;
    ...
    protected RelativeLayout mMessageBlock;
    ...
    public MessageListViewHolder(QKActivity context, View view) {
        ...
        mTolchTextView = (TextView) view.findViewById(R.id.tolch_view);
        ...
        mMessageBlock = (RelativeLayout) view.findViewById(R.id.message_block);
    ...
    static protected class ImageLoadedCallback implements ItemLoadedCallback<ThumbnailManager.ImageLoaded> {
        ...
        public void onItemLoaded(ThumbnailManager.ImageLoaded imageLoaded, Throwable exception) {
            ...
            JoinedMessageItem msgItem = mListItem.mData;
