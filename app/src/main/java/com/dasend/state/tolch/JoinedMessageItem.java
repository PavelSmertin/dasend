 ...
 */
public class JoinedMessageItem {
    private static String TAG = "JoinedMessageItem";
    ...
    public JoinedMessageColumns.ColumnsMap mColumnsMap;
    private PduLoadedCallback mPduLoadedCallback;
    private ItemLoadedFuture mItemLoadedFuture;

    @SuppressLint("NewApi")
    public JoinedMessageItem(Context context, String type, final Cursor cursor,
                             final JoinedMessageColumns.ColumnsMap columnsMap, Pattern highlight,
        ...
        if ("sms".equals(type)) {
            ...
            mTolch = new Tolch(
                    cursor.getFloat(columnsMap.mColumnGood),
                    cursor.getFloat(columnsMap.mColumnBad),
                    cursor.getFloat(columnsMap.mColumnNeutral)
            );
    ...
    public class PduLoadedMessageItemCallback implements ItemLoadedCallback {
        public void onItemLoaded(Object result, Throwable exception) {
            ...
            if (mPduLoadedCallback != null) {
                mPduLoadedCallback.onPduLoaded(JoinedMessageItem.this);
            }
        }
    }
    ...
    public interface PduLoadedCallback {
         ...
         */
        void onPduLoaded(JoinedMessageItem joinedMessageItem);
    }
