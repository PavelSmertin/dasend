...
public class ThemeManager {
    ...
    static class ColorPickerViewHolder {
        @BindView(R2.id.tab_1) QKTextView mTab1;
        @BindView(R2.id.tab_2) QKTextView mTab2;
        @BindView(R2.id.pager) ViewPager mPager;
        @BindView(R2.id.palette) ColorPickerPalette mPalette;
        @BindView(R2.id.preview) View mPreview;
        @BindView(R2.id.red) SeekBar mRed;
        @BindView(R2.id.red_value) QKTextView mRedValue;
        @BindView(R2.id.green) SeekBar mGreen;
        @BindView(R2.id.green_value) QKTextView mGreenValue;
        @BindView(R2.id.blue) SeekBar mBlue;
        @BindView(R2.id.blue_value) QKTextView mBlueValue;
        @BindView(R2.id.hex) QKEditText mHex;
        @BindView(R2.id.error) ImageView mError;
